...
//do API call for the eventId to get event Info
  ...
  return (
    ...
    <div className='container mt-5'>
      ...
      <div className='row'>
        <div className='col'>
        <img className='img img-fluid' src='https://media.istockphoto.com/id/499517325/photo/a-man-speaking-at-a-business-conference.jpg?s=612x612&w=0&k=20&c=gWTTDs_Hl6AEGOunoQ2LsjrcTJkknf9G8BGqsywyEtE=' alt="alt"></img>
        </div>
        <div className='col'>
